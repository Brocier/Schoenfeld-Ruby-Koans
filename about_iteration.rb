...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject performs the same operation as reduce, taking a group of items and performing an operation on all of them, then spitting out the final total. 
  end
  ...
  #
  # 
  # We only want the file to be open when we need it, not having it taking up a process and memory space constantly.
